      ...
      <div className='w-5/6	 max-w-md p-10 -space-y-px rounded-md shadow-sm bg-white '>
        <form onSubmit={handleSubmit}>
          ...
          <div className='text-sm mb-6'>
            <label htmlFor='company-name' className='block mb-2 text-sm font-bold text-gray-900 dark:text-white'>
              Company Name
            </label>
            <input
              type='text'
          ...
          <div className='form-group'>
            <label htmlFor='job-level' className='block mb-2 text-sm font-bold text-gray-900 dark:text-white'>
              Job Level
            </label>
            <input
              type='text'
          ...
          <div className='form-group'>
            <label htmlFor='job-field' className='block mb-2 text-sm font-bold text-gray-900 dark:text-white'>
              Job Field
            </label>
            <input
              type='text'
          ...
          <div className='form-group'>
            <label htmlFor='job-title' className='block mb-2 text-sm font-bold text-gray-900 dark:text-white'>
              Job Title
            </label>
            <input
              type='text'
          ...
          <div className='form-group'>
            <label htmlFor='video' className='block mb-2 text-sm font-bold text-gray-900 dark:text-white'>
              Video?
            </label>
